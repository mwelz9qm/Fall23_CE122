...
void problem2()
{
    ...
    int myList[9] = {8,10,6,2,7,6,12,14,29}; //the list I am testing against
...
{
    //var for tracking the smallest element in the array -- start with the first and adjust as needed
    int minIndex = 0;
    for (int i = 0; i < l; i++)
    {
        if (list[i] < list[minIndex])  //if we come across a new smallest value, set the minValue and its location
            minIndex = i;
